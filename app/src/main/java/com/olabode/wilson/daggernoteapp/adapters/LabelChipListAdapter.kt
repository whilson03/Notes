 ...
 */
class LabelChipListAdapter :
    ListAdapter<Label, LabelChipListAdapter.LabelChipViewHolder>(LabelDiffCallBack()) {
    ...
    class LabelChipViewHolder constructor(val binding: ItemLabelChipBinding) :
